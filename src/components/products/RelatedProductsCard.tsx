...
import ProductVariantMRP from './ProductVariantMRP'; // Import ProductVariantMRP component
			...
			<a class="flex flex-col mx-auto" href={`/products/${slug}/`} onClick$={handleProductClick}>
				...
				{hasDiscount && (
					<div class="flex flex-wrap items-center mt-1">
						...
						{/* Conditionally render MRP */}
						{MRP !== null && (
							<span class="line-through">MRP: {formatPrice(MRP || 0, currencyCode || 'INR')}</span>
						)}
					</div>
				)}
