    ...
    <div>
      <div class="max-w-6xl mx-auto px-4 py-10">
        <div>
          ...
          <Breadcrumbs
            items={
              productSignal.value.collections[
                productSignal.value.collections.length - 1
              ]?.breadcrumbs ?? []
            }
          ></Breadcrumbs>
              ...
              <span class="rounded-md overflow-hidden">
                <div class="h-[400px] w-full md:w-[400px]">
                  <Image
                    ...
                    height="400"
                    src={
                      currentImageSig.value.preview + "?w=400&h=400&format=webp"
                    }
                    ...
                    {productSignal.value.assets.map((asset, key) => (
                      <Image
                        ...
                        class={{
                          ...
                          "border-b-8 border-primary-600":
                            currentImageSig.value.id === asset.id,
                        }}
                        width="80"
                        height="80"
            ...
            <div class="mt-10 px-4 sm:px-0 sm:mt-16 lg:mt-0">
              ...
              {1 < productSignal.value.variants.length && (
                <div class="mt-4">
                  ...
                  <select
                    ...
                    onChange$={(e: any) =>
                      (selectedVariantIdSignal.value = e.target.value)
                    }
                  >
              ...
              <div class="mt-2 flex items-center space-x-2">
                <span class="text-gray-500">
                  {selectedVariantSignal.value?.sku}
                </span>
                <StockLevelLabel
                  stockLevel={selectedVariantSignal.value?.stockLevel}
                />
              </div>
              {!!addItemToOrderErrorSignal.value && (
                <div class="mt-4">
      ...
      <div class="mt-4">
        ...
        <div class="bg-white p-8 mx-4">
          <div
            id="details"
            class={`tab-content ${
              activeTabSignal.value === "details" ? "" : "hidden"
            }`}
          >
            {/* Details content */}
            ...
            <div
              ...
              dangerouslySetInnerHTML={
                (productSignal.value.customFields as ProductCustomFields)
                  ?.additionalInfo ?? ""
              }
            />
          </div>
          <div
            id="specifications"
            class={`tab-content ${
              activeTabSignal.value === "specifications" ? "" : "hidden"
            }`}
          >
            ...
            <ul>
              ...
              <li>
                ...
                {(productSignal.value.customFields as ProductCustomFields)
                  ...
                  (
                    productSignal.value.customFields as ProductCustomFields
                  )?.infoUrl.startsWith("http://") ||
                  (
                    productSignal.value.customFields as ProductCustomFields
                  )?.infoUrl.startsWith("https://") ? (
                    <a
                      href={
                        (
                          productSignal.value
                            .customFields as ProductCustomFields
                        )?.infoUrl
                      }
                      target="_blank"
              ...
              <li>
                ...
                {(productSignal.value.customFields as ProductCustomFields)
                  ?.shortName || "No Data Available"}
              </li>
              <li>
                <strong>Meta Title:</strong>{" "}
                {(productSignal.value.customFields as ProductCustomFields)
                  ?.metaTitle || "No Data Available"}
              </li>
              <li>
                <strong>Meta Description:</strong>{" "}
                {(productSignal.value.customFields as ProductCustomFields)
                  ?.metaDescription || "No Data Available"}
              </li>
              <li>
          ...
          <div
            id="reviews"
            class={`tab-content ${
              activeTabSignal.value === "reviews" ? "" : "hidden"
            }`}
          >
            {/* Reviews content */}
